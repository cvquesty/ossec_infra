...
## Puppet Master VM ##
######################
  # Configure the Master VM Characteristics
...
####################
  ...
  development.vm.provider :virtualbox do |settings|
    settings.memory = 512
    settings.name = "development_po6.18"
    settings.cpus = 1
  end
...
###################
  ...
  production.vm.provider :virtualbox do |settings|
    settings.memory = 512
    settings.name = "production_po6.18"
    settings.cpus = 1
  end
